...
class MyScrollToBottomObserver(
    ...
    var adapter:ChattersChatAdapter,
    var manager:LinearLayoutManager):RecyclerView.AdapterDataObserver() {

    override fun onItemRangeInserted(positionStart: Int, itemCount: Int) {
        super.onItemRangeInserted(positionStart, itemCount)
        var count=adapter.itemCount
        var lastVisiblePosition = manager.findLastCompletelyVisibleItemPosition()
